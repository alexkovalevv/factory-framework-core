<?php
	...
	if( !class_exists('Wbcr_Factory000_RegisterNotice') ) {
		/**
		 ...
		 */
		class Wbcr_Factory000_RegisterNotice {
			 ...
			 */
			public function __construct(Wbcr_Factory000_Plugin $plugin, $message, $type, array $where = array(), $dismiss_time = YEAR_IN_SECONDS)
			{
				if( empty($message) ) {
