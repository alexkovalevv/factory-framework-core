 ...
 * @since 1.0.0
 *
 * @see wbcr_factory_000_deprecated_hook()
 *
 ...
 * @return mixed
 */
function wbcr_factory_000_apply_filters_deprecated( $tag, $args, $version, $replacement = false, $message = null ) {
	...
	wbcr_factory_000_deprecated_hook( $tag, $version, $replacement, $message );
 ...
 * @return void
 */
function wbcr_factory_000_do_action_deprecated( $tag, $args, $version, $replacement = false, $message = null ) {
 ...
 *
 * Use the 'wbcr_factory_000_deprecated_hook_run' action to get the backtrace describing where the
 ...
 * @param string $message Optional. A message regarding the change.
 */
function wbcr_factory_000_deprecated_hook( $hook, $version, $replacement = null, $message = null ) {
	/**
