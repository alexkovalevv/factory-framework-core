...
if ( ! class_exists( 'Wbcr_Factory000_Requirements' ) ) {
	class Wbcr_Factory000_Requirements {
		...
		protected function get_php_incompat_text() {
			return sprintf( __( 'You need to update the PHP version to %s or higher!', 'wbcr_factory_000' ), $this->required_php_version );
		}
		...
		protected function get_wp_incompat_text() {
			return sprintf( __( 'You need to update WordPress to %s or higher!', 'wbcr_factory_000' ), $this->required_wp_version );
		}
		...
		protected function get_plugin_already_activate_text() {
			return sprintf( __( 'Plugin %s is already activated, you are trying to activate it again.', 'wbcr_factory_000' ), $this->plugin_title );
		}
	}
}