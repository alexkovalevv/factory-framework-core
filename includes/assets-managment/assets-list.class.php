<?php
	...
	if( !class_exists('Wbcr_Factory000_AssetsList') ) {
		/**
		 * Assets List
		 *
		 * @since 1.0.0
		 */
		class Wbcr_Factory000_AssetsList {
			 ...
			 */
			public function __construct(Wbcr_Factory000_Plugin $plugin, $defaultIsFooter = true)
			{
				$this->plugin = $plugin;
